...
if st.button("運命を占う"):
    if not api_key:
        st.error("APIキーが設定されていません。SettingsのSecretsを確認してください。")
    elif nickname:
        ...
        with st.spinner("星の声を聴いています..."):
            prompt = f"プロの占い師として、{nickname}さん（ライフパスナンバー{life_path}）が引いたタロット『{selected_card_name}』に基づき、魂の本質と現状へのアドバイスを神秘的な口調で鑑定してください。"
        ...
        my_sales_url = "https://coconala.com/" # ここをあなたのURLに変更
